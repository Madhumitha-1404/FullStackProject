...
public class RestaurantController {
	...
	public ResponseEntity<List<SwiggyModel>> getRestaurantDetails(@RequestParam (required= false) String restaurantName){
		...
		try {
			...
			if(restaurantName != null) {
				resRepo.findByRestaurantNameContaining(restaurantName).forEach(resList::add);
	...
	public ResponseEntity<List<SwiggyModel>> findByVegHotel(){
		try {
			List<SwiggyModel> vegHotelList=resRepo.findByfoodTypeContaining("veg");
...
public ResponseEntity<List<SwiggyModel>> findByNonVegHotel(){
	try {
		List<SwiggyModel> nonVegHotelList=resRepo.findByfoodTypeContaining("nonveg");
